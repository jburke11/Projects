...
print ("Second card dealt to player #1: ", player1_list[0])
player1_list.pop(0)
print ("Player #1 hand:", player1_list)
print ()
print ("Second card dealt to player #2: ", player2_list[0])
player2_list.pop(0)
print ("Player #2 hand:", player2_list)      
print ()
print ("Last card in hand of player #1:", player1_list[-1])
print ("Last card in hand of player #2:", player2_list[-1])
print ()
if player1_list[-1].rank() == player2_list[-1].rank():
    print( player1_list[-1], "and", player2_list[-1], "of equal rank" )
elif player1_list[-1].rank() > player2_list[-1].rank():
    print( player1_list[-1], "of higher rank than", player2_list[-1] )
else:
    print( player2_list[-1], "of higher rank than", player1_list[-1] )